...
import { FiSearch, FiEye, FiCheckCircle, FiXCircle, FiAlertCircle, FiTrendingUp } from 'react-icons/fi'
...
export default function SellersPage() {
  ...
  }, [token, page, statusFilter, tierFilter, verificationFilter])
  ...
  async function fetchSellers() {
    try {
      ...
      const res = await axios.get(`/api/admin/sellers?${params}`, {
                ...
                <tbody className="divide-y divide-gray-200">
                  {sellers.map(seller => (
                    <tr key={seller._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm text-gray-900">{seller.ownerName || seller.userId?.name}</p>
                      ...
                      <td className="px-6 py-4">
                        {seller.isVerified ? (
                          ...
                          <span className="flex items-center space-x-1 text-yellow-600 text-sm font-semibold">
                            <FiAlertCircle />
                            <span>Pending</span>
                          </span>
                        ) : (
