...
import {
  FiPackage, FiBox, FiTruck, FiCheckCircle,
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <label
                key={key}
                className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition ${checklist[key]
              ...
              >
                ...
                />
                <Icon
                  className={`text-2xl ${checklist[key] ? "text-green-600" : "text-gray-400"
                    }`}
                />
                <span
                  className={`flex-1 font-medium ${checklist[key] ? "text-green-900" : "text-gray-700"
                    }`}
                >
                  {label}
                </span>
