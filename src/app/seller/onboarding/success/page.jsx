        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center py-12 px-4 selection:bg-emerald-100">
            <div className="max-w-2xl w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl lg:text-5xl font-semibold text-gray-900 mb-4 tracking-tighter">
                ...
                <div className="bg-white rounded-[3rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] p-8 lg:p-14 space-y-10 border border-white">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={item.step} className="flex gap-4 p-5 bg-gray-50/50 rounded-2xl border border-gray-100 hover:bg-emerald-50 hover:border-emerald-100 transition-all group">
                                    <div className="flex-shrink-0 w-10 h-10 bg-white border border-gray-200 rounded-xl flex items-center justify-center text-gray-900 font-semibold group-hover:bg-emerald-600 group-hover:text-white group-hover:border-emerald-600 transition-all">
                                        {item.step}
                                    </div>
                                    <div className="flex-1">
                                        <h3 className="font-semibold text-gray-900 mb-1">{item.title}</h3>
                                        <p className="text-sm text-gray-500 mb-2">{item.description}</p>
                                        <span className="text-[10px] font-semibold uppercase tracking-widest text-emerald-600">⏱ {item.time}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="text-center pt-2">
                        <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-[0.2em] mb-4">Application Reference</p>
                        <div className="inline-block px-8 py-4 bg-gray-50 rounded-2xl border border-gray-100">
                            <code className="text-2xl font-mono font-semibold text-gray-900 tracking-tighter">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <Link
                            href="/"
                            className="flex-1 flex items-center justify-center gap-2 px-8 py-5 bg-gray-900 text-white rounded-2xl font-semibold hover:bg-black transition-all shadow-xl shadow-gray-200"
                        >
                        ...
                        <a
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-8 py-5 bg-white border border-gray-200 text-gray-700 rounded-2xl font-semibold hover:bg-gray-50 transition-all"
                        >
                            <Mail size={18} />
