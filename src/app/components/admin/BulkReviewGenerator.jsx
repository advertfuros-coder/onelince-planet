        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-semibold mb-2">Bulk Review Generator</h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[10, 20, 50, 100].map(count => (
                  <button
                    ...
                    className={`px-6 py-4 rounded-lg font-semibold text-lg transition-all transform hover:scale-105 ${
                      reviewCount === count
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <p className="text-3xl font-semibold text-blue-600">{result.insertedCount}</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg">
                    <p className="text-sm text-gray-600">Total Reviews</p>
                    <p className="text-3xl font-semibold text-green-600">{result.newRating?.count || 0}</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg col-span-2">
                    <p className="text-sm text-gray-600">New Average Rating</p>
                    <div className="flex items-center gap-2">
                      <p className="text-3xl font-semibold text-yellow-600">{result.newRating?.average || 0}</p>
