            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <span className="text-yellow-600 font-semibold text-[9px] uppercase tracking-widest mb-0.5 block">LIMITED TIME SPECIAL</span>
                    ...
                    <div className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-xl shadow-lg">
                        <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Ends in:</span>
                        <div className="flex items-center gap-1.5">
                            {[
                                ...
                                <div key={index} className="flex items-center gap-1">
                                    <span className="bg-white/10 backdrop-blur-md text-white px-2 py-1 rounded-lg text-base font-semibold min-w-[34px] text-center border border-white/5">
                        ...
                        <div className="relative h-[400px] md:h-[500px] lg:h-[600px] bg-white overflow-hidden">
                            ...
                            {discount > 0 && (
                                <div className="absolute top-8 left-8 z-20">
                                    <div className="bg-red-600 text-white px-6 py-2.5 rounded-2xl font-semibold text-2xl shadow-xl shadow-red-200 rotate-[-5deg]">
                                        -{discount}%
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <div className="flex items-center text-yellow-400">
                                    ...
                                    <span className="text-gray-900 font-semibold text-sm ml-1">4.9</span>
                                    <span className="text-gray-400 text-sm ml-1">(2.5k reviews)</span>
                                </div>
                            </div>

                            <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-3 leading-tight group-hover:text-blue-600 transition-colors">
                            ...
                            <div className="flex items-center gap-6 mb-6">
                                <div className="flex flex-col">
                                    <span className="text-3xl md:text-4xl font-semibold text-gray-900 tracking-tighter">
                                ...
                                <div className="hidden md:flex flex-col">
                                    <span className="text-green-600 font-semibold text-sm">Save {formatPrice(originalPrice - salePrice, region)}</span>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 mb-6">
                                <Link
                                    ...
                                    className="flex-[2] bg-blue-600 text-white py-3 px-6 rounded-xl font-semibold text-sm hover:bg-blue-700 shadow-xl shadow-blue-100 hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2"
                                >
                                ...
                                <Link
                                    href={`/products/${deal?._id}`}
                                    className="flex-1 bg-white text-gray-900 border border-gray-100 py-3 px-6 rounded-xl font-semibold text-sm hover:border-gray-200 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center"
                                >
                                    Details
                                </Link>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-8 border-t border-gray-100">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs font-semibold text-gray-700">24h Delivery</span>
                                </div>
