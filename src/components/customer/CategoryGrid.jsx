...
export default function CategoryGrid() {
    const categories = [
        ...
        { name: 'Appliances', image: '/category-icons/appliances.png', href: '/category/home', gradient: 'from-gray-500 to-gray-700' },
         ...
         { name: 'Books', image: '/category-icons/books.png', href: '/category/books', gradient: 'from-indigo-500 to-purple-600' },
        ...
        { name: 'Large Appliances', image: '/category-icons/appliances.png', href: '/category/home', gradient: 'from-slate-700 to-slate-900' },
