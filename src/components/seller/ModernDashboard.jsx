                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="px-5 py-2.5 bg-white border border-gray-200 rounded-full font-bold text-gray-700 hover:bg-gray-50 transition-all flex items-center gap-2"
                        >
                        ...
                        <Link
                            ...
                            className="flex items-center gap-2 px-6 py-2.5 bg-[#1E3A8A] text-white rounded-full font-bold hover:bg-black transition-all shadow-lg shadow-blue-900/10"
                        >
                            <Plus size={18} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-2 bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100/50">
                                <div className="flex items-center justify-between mb-2">
                                    <div>
                                        <h3 className="font-bold text-gray-900 text-xl">Revenue Analytics</h3>
                                        <p className="text-[11px] text-gray-400 font-bold uppercase tracking-wider">Store performance analytics</p>
                                    </div>
                                    <div className="flex items-center gap-2 bg-gray-50 border border-gray-100 rounded-full px-4 py-1.5 text-xs font-bold text-gray-500 cursor-pointer hover:bg-gray-100 transition-colors">
                                ...
                                <div className="flex flex-col lg:flex-row h-[320px] mt-4 relative">
                                    ...
                                    <div className="hidden lg:flex flex-col justify-center gap-6 pr-8 border-r border-gray-50">
                                        <button className="text-[11px] font-black text-gray-300 hover:text-gray-500 transition-colors uppercase vertical-text">Aug</button>
                                        <button className="text-[11px] font-black text-white bg-blue-600 px-2 py-3 rounded-full uppercase vertical-text shadow-lg shadow-blue-500/30">Sep</button>
                                        <button className="text-[11px] font-black text-gray-300 hover:text-gray-500 transition-colors uppercase vertical-text">Oct</button>
                                        <button className="text-[11px] font-black text-gray-300 hover:text-gray-500 transition-colors uppercase vertical-text">Nov</button>
                                    </div>
                                ...
                                <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-50">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="text-right">
                                            <p className="text-2xl font-black text-gray-900 tracking-tighter">{safeData.revenueGrowth}%</p>
                            ...
                            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100/50 flex flex-col">
                                ...
                                <div className="flex-1 space-y-2 py-4">
                                    {safeData.alerts.pendingOrders > 0 ? (
                                        <>
                                            <h4 className="text-2xl font-bold leading-tight text-[#1E3A8A]">
                                ...
                                <Link
                                    href="/seller/orders"
                                    className="w-full h-14 bg-[#1E3A8A] text-white rounded-2xl flex items-center justify-center gap-2 font-bold hover:bg-black transition-all shadow-lg shadow-blue-900/20"
                                >
                                    <ShoppingBag size={20} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100/50 text-gray-900">
                                <div className="flex items-center justify-between mb-8">
                                    ...
                                    <Link href="/seller/products" className="text-xs px-4 py-1.5 border border-gray-100 rounded-full font-bold text-gray-500 hover:bg-gray-50 transition-colors">
                                        View All
                                    </Link>
                                </div>
                                    ...
                                    {safeData.topProducts.slice(0, 4).map((product, i) => (
                                        <div key={i} className="flex items-center justify-between group">
                                            <div className="flex items-center gap-4">
                                                <div className="w-11 h-11 rounded-2xl bg-blue-50 flex items-center justify-center text-blue-600 font-bold text-sm border border-blue-100/50 transition-transform group-hover:scale-105">
                                                    {product.name.charAt(0)}
                                                </div>
                                                <div>
                                                    <p className="text-sm font-bold truncate max-w-[150px]">{product.name}</p>
                                                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{product.sales} Sales Generated</p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-sm font-black text-gray-900">₹{product.revenue.toLocaleString()}</p>
                                                <span className="text-[10px] font-bold text-blue-600 px-2 py-0.5 bg-blue-50 rounded-lg">Revenue</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100/50">
                                <h3 className="font-bold text-gray-900 text-lg mb-2">Order Fulfillment</h3>
                                <div className="relative h-48 flex items-center justify-center">
                                    <div className="text-center absolute z-10 bottom-4 left-1/2 -translate-x-1/2">
                                        <p className="text-4xl font-black text-gray-900 tracking-tighter">{safeData.performance.orderFulfillmentRate.toFixed(1)}%</p>
                                ...
                                <div className="flex justify-center gap-8 mt-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Fulfilled</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <div className="w-3 h-3 rounded-full bg-slate-200" />
                                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">In Pipeline</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                                ...
                                {safeData.recentOrders.slice(0, 5).map((order) => (
                                    <div key={order.orderId} className="flex items-start gap-4 group cursor-pointer">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h4 className="text-sm font-bold text-gray-900 group-hover:text-blue-600 transition-colors truncate">#{order.orderId}</h4>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase mt-0.5">{order.status}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="bg-[#0A1128] rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden group">
                            ...
                            <h3 className="text-white font-bold text-lg mb-6 relative z-10">Seller Support</h3>
                            <div className="relative z-10 py-2">
                                <p className="text-blue-400 text-[10px] font-black uppercase tracking-[0.2em] mb-4">Dedicated Helpdesk</p>
                                ...
                                <button className="w-full mt-10 py-4 bg-white text-gray-900 rounded-2xl text-xs font-black hover:bg-blue-50 transition-all active:scale-95 shadow-lg">
                                    GET HELP NOW
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden group">
                            <div className="relative z-10">
                                <h4 className="font-bold text-xl leading-tight mb-2">Inventory Alerts</h4>
                                ...
                                <Link
                                    ...
                                    className="flex items-center justify-center w-full h-12 bg-black/20 backdrop-blur-md text-white rounded-2xl text-[11px] font-black hover:bg-black/30 transition-all border border-white/10"
                                >
                                    MANAGE STOCK
                                </Link>
                            </div>
    ...
    return (
        <div className={`p-6 rounded-[2.2rem] shadow-sm border transition-all hover:translate-y-[-4px] ${primary ? 'bg-[#1E3A8A] border-blue-800 text-white' : 'bg-white border-gray-100 text-gray-900'
            ...
            <div className="flex justify-between items-start mb-5">
                <h4 className={`text-xs font-bold uppercase tracking-wider ${primary ? 'text-white/60' : 'text-gray-400'}`}>{title}</h4>
            ...
            <div className="space-y-1">
                ...
                <p className={`text-[10px] font-bold mt-2 ${primary ? 'text-white/60' : 'text-gray-400'}`}>
